...
- Do not edit version fields manually; use `npm version` so `package.json`, `package-lock.json`, and the git tag stay synchronized, and keep `public/manifest.json` aligned via the sync script.
